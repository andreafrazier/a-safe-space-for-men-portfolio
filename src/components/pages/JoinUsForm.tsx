...
const JoinUsForm: React.FC<JoinUsFormProps> = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Temporary: Just simulate form submission for now
      // Replace this with your preferred form handling solution later
  ...
  return (
    ...
    >
      ...
      <div className="text-sm text-amber-700 bg-amber-50 p-4 rounded-lg border border-amber-200">
        <p className="font-semibold mb-1">Form Submission Temporarily Disabled</p>
        <p>
          We're currently setting up our form handling system. Your information will be processed once we complete the setup. 
          In the meantime, you can contact us directly at asafespaceformen@gmail.com.
        </p>
      </div>
