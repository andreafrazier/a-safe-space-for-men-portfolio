...
interface Event {
  ...
  category: 'support-group' | 'workshop' | 'community' | 'awareness';
  image?: string;
  capacity?: number;
  registered?: number;
  cost: string;
  ...
  const events: Event[] = [
    {
      ...
      description: "A safe space for men to openly discuss mental health challenges, share experiences, and support each other. Facilitated by peer leaders with lived experience.",
      date: "2025-11-06", // Next Thursday
      time: "7:00 PM - 8:30 PM",
      location: "SafetyZone Behavioral Health Center, Detroit",
    ...
    {
      id: 2,
      title: "Understanding Depression: A Workshop for Men",
      description: "Learn to recognize signs of depression, understand treatment options, and develop coping strategies. Led by licensed mental health professionals.",
      date: "2025-11-15",
    ...
    },
    {
      ...
      description: "Join us for a 5K community walk to raise awareness about men's mental health and break the stigma. Family-friendly event with refreshments provided.",
      date: "2025-11-22",
      ...
      category: "community",
      cost: "Free",
      tags: ["Community", "Awareness", "Fundraiser"],
      registrationLink: "/join"
    },
    {
      id: 4,
      title: "Coping with Grief and Loss",
      description: "A supportive workshop for men dealing with loss, whether it's a loved one, job, relationship, or life transition. Learn healthy coping mechanisms.",
      date: "2025-12-05",
      time: "6:30 PM - 8:00 PM",
      location: "Henry Ford Health Center, Detroit",
      locationType: "in-person",
      category: "workshop",
      capacity: 25,
      registered: 12,
    ...
    {
      id: 5,
      title: "Virtual Men's Coffee Chat",
      description: "Casual virtual meetup for men to connect, share stories, and support each other over coffee. No agenda, just authentic conversation.",
      date: "2025-11-09",
      ...
      category: "support-group",
      cost: "Free",
      tags: ["Virtual", "Casual", "Connection"],
      recurring: true
    },
    {
      id: 6,
      title: "Men's Mental Health Awareness Month Kickoff",
      description: "Join us for a special event launching Men's Mental Health Awareness Month with guest speakers, resources, and community building.",
      date: "2025-11-01",
      time: "5:00 PM - 7:30 PM",
      location: "Meijer Community Center, Detroit",
      locationType: "in-person",
      category: "awareness",
      capacity: 100,
      registered: 47,
    ...
    {
      id: 7,
      title: "Fatherhood and Mental Health Panel",
      description: "Panel discussion featuring fathers sharing their mental health journeys, challenges of parenting while managing mental health, and resources for dads.",
      date: "2025-12-12",
      time: "7:00 PM - 8:30 PM",
      ...
      registered: 18,
      cost: "Free",
      tags: ["Fatherhood", "Parenting", "Mental Health"]
    },
    {
      id: 8,
      title: "Managing Stress and Anxiety Workshop",
      description: "Practical strategies for managing stress and anxiety in daily life. Includes breathing exercises, mindfulness techniques, and resource sharing.",
      date: "2025-11-20",
      ...
      <section className="pt-16 bg-gradient-to-br from-emerald-50 to-blue-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Calendar className="w-20 h-20 text-emerald-600 mx-auto mb-6" />
